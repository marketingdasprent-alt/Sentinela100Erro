# SENTINELA100ERRO — Site institucional (protótipo arquivado)

> **Arquivado.** Esta é a versão estática inicial do site, mantida aqui só como
> referência histórica. O site em produção é a app Next.js na raiz do repositório —
> ver `../README.md`.
