...
substituindo o protótipo estático em `../index.html`. Ver `../PRODUCTION_BRIEF.md` para
o contexto completo da migração e a checklist de conteúdo real por fornecer.
